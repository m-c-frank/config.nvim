...
local function makeCurlRequest(prompt, callback)
...
local function displayOverlay(response)
...
function _G.generateText()
    local prompt = getPrompt()
    makeCurlRequest(prompt, displayOverlay)
end

-- Command to trigger the text generation
vim.api.nvim_create_user_command('Gen', generateText, {})
